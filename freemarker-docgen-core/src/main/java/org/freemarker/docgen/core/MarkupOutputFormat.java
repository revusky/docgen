...
public abstract class MarkupOutputFormat<MO extends TemplateMarkupOutputModel> {// extends OutputFormat {
     ...
     */
    public abstract void output(String textToEsc, Writer out) throws IOException;
     ...
     * @since 2.3.32
     */
    public <MO2 extends TemplateMarkupOutputModel<MO2>> void outputForeign(MO2 mo, Writer out) throws IOException {
     ...
     */
    public abstract String getSourcePlainText(MO mo);
     ...
     */
    public abstract String getMarkupString(MO mo);
     ...
     */
    public abstract MO concat(MO mo1, MO mo2);
     ...
     */
    public abstract String escapePlainText(String plainTextContent);

    /**
     * Returns if the markup is empty (0 length). This is used by at least {@code ?hasContent}.
     */
    public abstract boolean isEmpty(MO mo);
